...
import { openrestyClean, openrestyLint, registerApiCheck } from "./lua/apicheck";
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(vscode.commands.registerCommand('openresty.lint'     , openrestyLint     ));
	context.subscriptions.push(vscode.commands.registerCommand('openresty.clean'    , openrestyClean    ));
